...
#define LBL_SKU                   _("Own SKU")
#define LBL_NAME                  _("Name")
#define LBL_QUALITY               _("Quality")
#define LBL_CATEGORY              _("Category")
#define LBL_COLOR                 _("Color")
#define LBL_QUANTITY              _("Quantity")
#define LBL_PURCHASE_PRICE        _("Purchase price")
#define LBL_EX_VAT                _("Ex. VAT")
...
#define SUPPLIER_ADDR_1           _("Line 1")
#define SUPPLIER_ADDR_2           _("Line 2")
#define SUPPLIER_ADDR_3           _("Line 3")
#define SUPPLIER_ADDR_4           _("Line 4")
#define SUPPLIER_ADDR_5           _("Line 5")
                                  
// View labels
#define LBL_SUPPLIER             _("Supplier")

// Insert                         
#define LBL_SUPPLIER_INSERT       _("Update supplier?")

// Edit
#define LBL_SUPPLIER_EDIT         _("Edit supplier")

// Update
#define LBL_SUPPLIER_UPDATE      _("Update supplier?")
